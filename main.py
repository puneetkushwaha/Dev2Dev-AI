...
async def generate_lesson(req: LessonRequest):
    ...
    messages = [
        ...
        {"role": "user", "content": (
            ...
            "6. 'solution_stub': A clean starter function template. Ensure function names are logical (e.g., 'climbStairs' or 'solution').\n"
            "7. 'testCases': Array of >=3 objects. Each MUST have:\n"
            "   - 'input': Valid JS expression to call the function (e.g., 'solution(5)').\n"
